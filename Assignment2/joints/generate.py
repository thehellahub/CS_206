...
# 	height = 1
# 													#    x,y,z
# 	pyrosim.Send_Cube(	name =f"BackLeg", 			pos=[0,0,.5] , 	size=[length,width,height])
# 	pyrosim.Send_Joint(	name =f"Torso_BackLeg" , 	parent= "BackLeg" , 	child = "Torso" , type = "revolute", position = [0,.5,1])
# 	pyrosim.Send_Cube(	name =f"Torso", 			pos=[0,0.5,0.5] , size=[length,width,height])
# 	pyrosim.Send_Joint(	name =f"Torso_Frontleg" , 	parent= "Torso" , 	child = "FrontLeg" , type = "revolute", position = [0,1,0])
# 	pyrosim.Send_Cube(	name =f"FrontLeg", 			pos=[0,.5,-.5] , 	size=[length,width,height])
